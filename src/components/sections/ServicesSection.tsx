...
import { Smartphone, MonitorPlay, Palette, Monitor } from "lucide-react";

const SERVICES = [
  {
    title: "WEB APP Development",
    icon: <Monitor size={40} className="mb-6 text-neon-green" />,
    description: "Building scalable, high-performance Laravel Web applications.",
    features: ["Laravel", "PHP", "MySQL"],
  },
  {
    ...
    features: ["React & Vue.js", "Tailwind CSS",],
  },
  {
    title: "UI/UX Design",
