  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        I'm Abdelhamid, a passionate Full Stack Developer from Algeria. I specialize in building modern, responsive, and high-performance web applications using the Laravel ecosystem for the backend and Vue.js for the frontend. 
        With a strong foundation in JavaScript (ES6+), Tailwind CSS, and MySQL, I create seamless user experiences and scalable applications. I also have experience in desktop applications with Electron and interactive animations with GSAP.
        I love turning ideas into digital solutions that are not only functional but also visually engaging. When I'm not coding, I enjoy exploring new technologies, improving my skills, and contributing to open-source projects.
