      ...
      <footer className="mt-24 pt-8 border-t border-white/5 pb-8 relative z-10">
        <div className="container mx-auto max-w-4xl flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="font-mono text-xl font-bold tracking-tighter text-white">
            ABDELHAMID<span className="text-neon-green">.</span>
          </div>

          <div className="flex gap-6">
            <a href="https://www.instagram.com/hamid__alem?igsh=MWo4Y2lhcHM4Z3U3bQ%3D%3D&utm_source=qr" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-electric-purple transition-colors hover:scale-110">
              <Instagram size={20} />
            </a>
            <a href="mailto:alemabdelhamid06@gmail.com" className="text-gray-500 hover:text-neon-green transition-colors hover:scale-110">
              <Mail size={20} />
            </a>
            <a href="https://wa.me/213666405144" className="text-gray-500 hover:text-white transition-colors hover:scale-110">
              <Phone size={20} />
            </a>
          </div>
